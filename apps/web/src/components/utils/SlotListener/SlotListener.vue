...
export default defineComponent({
  ...
  render() {
    ...
    if (triggerVNode?.props) {
      const { onClick, onMouseenter, onMouseleave, onFocus, onBlur } = triggerVNode.props;
      ascendantAndCurrentHandlers.push(onClick, onMouseenter, onMouseleave, onFocus, onBlur);
    }
