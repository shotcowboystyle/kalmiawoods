...
const { checkStrength, scorePassword, hasSpecialChar, hasLowerCase, hasUpperCase, hasNumber } = usePasswordChecker();
...
<template>
  <div class="po-password-strength-bar mb-4" :class="passwordClass"></div>
  <ul>
