<script setup lang="ts">
	...
	const getStylePropValue = (variable: string) =>
		getComputedStyle(submitButton.value).getPropertyValue(variable);
...
<template>
	...
	<div class="form-control mb-4 w-full">
		...
		<input
			...
			name="name"
			type="text"
			class="input input-bordered w-full border-gray-300 bg-white text-gray-800"
		/>
	</div>
	<div class="form-control mb-4 w-full">
		<label
	...
	<div class="form-control mb-4 w-full">
		...
		<textarea
			id="message"
			name="message"
			class="3w-full textarea textarea-bordered border-gray-300 bg-white text-gray-800"
		></textarea>
	</div>

	<button
		ref="submitButton"
		class="btn-send-message self-center"
		@click.once="() => handleOnSubmit()"
	>
