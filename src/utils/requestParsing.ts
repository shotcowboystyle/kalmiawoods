...
export function parseRequestParams<T extends ZodRawShape>(
	...
	return zodRequestObject.parse(Object.fromEntries(new URL(request.url).searchParams));
}

export function parseParams<T extends ZodRawShape>(params: Object, zodRequestObject: ZodObject<T>) {
